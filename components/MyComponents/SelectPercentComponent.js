...
import { PERCENT_15 } from '../../constants';
import { formatPercentValue, getPercentsSnapshot } from '../../lib/firebase-functions/Percent/PercentFunctions';
...
export default function SelectPercentComponent(props) {
