                ...
                <Paper elevation={0} sx={{ maxWidth: drawerWidth }}>
                    <FireNav component="nav" disablePadding>
                        ...
                        <ListItem component="div" disablePadding>
                            ...
                            >
                                <ListItemIcon>
                                    <LogoutIcon sx={{ color: themeGeneral.palette.primary.main }} />
                                </ListItemIcon>
                                <ListItemText
                                    primary="Disconnect"
                                    primaryTypographyProps={{
                            ...
                            >
                                ...
                                <KeyboardArrowDown
                                    sx={{
                                        mr: -1,
                                        opacity: 0,
                                        transform: openTransfert ? 'rotate(-180deg)' : 'rotate(180deg)',
                                        transition: '0.2s',
                                    }}
                                />
                            </ListItemButton>
                            ...
                            >
                                ...
                                <KeyboardArrowDown
                                    sx={{
                                        mr: -1,
                                        opacity: 0,
                                        transform: openAccount ? 'rotate(-180deg)' : 'rotate(180deg)',
                                        transition: '0.2s',
                                    }}
                                />
                            </ListItemButton>
